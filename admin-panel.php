...
include('func.php');  
include('newfunc.php');
$con=mysqli_connect("localhost","root","Purva2308$$","myhmsdb");
...
if(isset($_GET["generate_bill"])){
  ...
  $content .= '
      <br/>
      <h2 align ="center"> HealthPulse Manager</h2></br>
...
<html lang="en">
  ...
  <a class="navbar-brand" href="#"><i class="fa fa-user-plus" aria-hidden="true"></i> HealthPulse Manager </a>
